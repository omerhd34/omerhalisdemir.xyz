   ...
   <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
     ...
     <div className="grid grid-cols-2 gap-4">
      ...
      <div className="bg-gray-700 p-2 sm:p-6 rounded-lg shadow-md flex flex-col items-center justify-center hover:bg-gray-600 transition duration-300 group relative">
